            ...
            <div style={{ position:"absolute", inset:0, background:"rgba(0,0,0,0.8)", display:"flex", alignItems:"flex-end", zIndex:200 }} onClick={() => setShowPrivacyModal(false)}>
              <div style={{ width:"100%", background: isDark ? "#1a1a2e" : "#fff", borderRadius:"24px 24px 0 0", padding:"24px 20px 40px", maxHeight:"80vh", overflowY:"auto", scrollbarWidth:"none" }} onClick={e => e.stopPropagation()}>
                ...
                {[
                  ...
                  ["2. Hvilke data vi indsamler", "Vi indsamler den e-mailadresse du opretter konto med, samt de finansielle transaktionsdata du selv uploader fra dit kontoudtog (CSV-format). Vi indsamler desuden anonyme brugsdata såsom antal sessioner og chatbeskeder til statistisk brug. Ingen andre brugere af Økonom kan på noget tidspunkt tilgå dine data — dette er teknisk håndhævet via Row Level Security. Økonoms ejer har som dataansvarlig teknisk adgang til databasen, men forpligter sig til ikke at tilgå individuelle brugeres transaktionsdata med mindre det er påkrævet ved lov."],
